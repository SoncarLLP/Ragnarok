...
export default function GroupSettingsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
      <div className="rounded-2xl p-6 w-full max-w-md max-h-[90vh] flex flex-col gap-5 overflow-y-auto shadow-2xl" style={{ background: "var(--nrs-card)", border: "1px solid var(--nrs-border)" }}>
