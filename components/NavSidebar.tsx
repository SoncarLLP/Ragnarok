  ...
  return (
    <>
      ...
      >
        ...
        {/* Nav links — padding-bottom ensures Sign Out scrolls fully above the PWA bottom nav */}
        <nav
          className="flex-1 overflow-y-auto px-4 py-4 space-y-1"
          style={{ paddingBottom: "calc(var(--pwa-nav-height, 0px) + env(safe-area-inset-bottom, 0px) + 16px)" }}
        >
          ...
          {/* Sign Out + copyright — inside the scroll area so they scroll fully
              above the PWA bottom nav. The nav's padding-bottom provides the gap. */}
          <div className="mt-2" style={{ borderTop: "1px solid var(--nrs-border)" }} />
          {isSignedIn && (
            <button
          ...
          <div className="text-xs px-4 py-2" style={{ color: "var(--nrs-text-muted)" }}>
